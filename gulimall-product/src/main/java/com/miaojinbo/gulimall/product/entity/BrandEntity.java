package com.miaojinbo.gulimall.product.entity;
...
import com.miaojinbo.common.valid.ListValue;
...
public class BrandEntity implements Serializable {
	...
	@Pattern(regexp = "^[a-zA-Z]$", message = "检索首字母必须 是一个字母", groups = {UpdateGroup.class, AddGroup.class})
